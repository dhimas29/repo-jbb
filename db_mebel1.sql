...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 05, 2020 at 06:38 AM
...
(146, 'Meja Lipat', '9884.jpg', 1, 'Panjang : 50cm,  Lebar : 45cm,  Tinggi :35cm', 140000, 10, 100000, 40, 'Meja lipat ini terbuat dari kayu jati belanda yang di cat berwarna coklat yang di desain secara minimalis dan bisa di lipat agar bisa di bawa kemana mana,cocok untuk meja belajar anak.'),
...
--
ALTER TABLE `tb_cart`
  MODIFY `id_cart` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=348;
...
--
ALTER TABLE `tb_transaksi`
  MODIFY `id_transaksi` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=298;
